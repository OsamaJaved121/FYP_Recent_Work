...
class Products with ChangeNotifier {
  ...
  List<Product> get items {
    print("The length of products is ${_items.length}");
    return [..._items];
  }
  ...
  Future<void> fetchAndSetProducts() async {
    ...
    try {
      ...
      print("The val of response in products is ${json.decode(response.body)}");
      final extractedData = json.decode(response.body) as Map<String, dynamic>;
      final List<Product> loadedProducts = [];
      if (extractedData == null) {
        print("The extracted data is null for some reason");
        return;
      }
      extractedData.forEach(
        (prodID, prodData) {
          print("Inside loop products");
          loadedProducts.add(
            Product(
              id: prodID,
